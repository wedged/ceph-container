...
IMAGES_TO_BUILD ?= \
	...
	kraken@amd64@ubuntu@_@ubuntu@16.04 \
	jewel@amd64@ubuntu@_@ubuntu@16.04 \
	jewel@amd64@ubuntu@_@ubuntu@14.04

# ====================================================================================
# Targets

base.%:
	@$(MAKE) -C base $(MAKECMDGOALS) CEPH_VERSION=$(word 1, $(subst @, ,$*)) ARCH=$(word 2, $(subst @, ,$*)) BASEOS_NAME=$(word 3, $(subst @, ,$*)) BASEOS_REG=$(word 4, $(subst @, ,$*)) BASEOS_REPO=$(word 5, $(subst @, ,$*)) BASEOS_TAG=$(word 6, $(subst @, ,$*))
